...
todoAddButton.addEventListener('click', function () {
  ...
  var todoItem = new _index_js__WEBPACK_IMPORTED_MODULE_0__.TodoItem(form.date.value, form.title.value, form.time.value, form.notes.value);
...
function setDisplayClickDateTodoModify(todoArrIndex) {
  var todoItem = _index_js__WEBPACK_IMPORTED_MODULE_0__.todoItemArr[todoArrIndex];
  var form = document.forms.todo;
...
function deleteClickListener() {
  ...
  deleteTodoListMenu.forEach(function (deleteBt) {
    deleteBt.addEventListener('click', function () {
      ...
      var idx = todoArrfindIndex(todoArrIndex);
      var date = _index_js__WEBPACK_IMPORTED_MODULE_0__.todoItemArr[idx].clickDate.split(/[^0-9]/g)[2];
      console.log(date);
...
function todoArrfindIndex(todoArrIndex) {
  var idx = _index_js__WEBPACK_IMPORTED_MODULE_0__.todoItemArr.findIndex(function (item, index) {
