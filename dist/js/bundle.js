...
/* harmony export */   "default": () => (/* binding */ insertDaysInCalendar)
/* harmony export */ });
/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../index.js */ "./src/js/index.js");
/* harmony import */ var _todo_todolist_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../todo/todolist.js */ "./src/js/todo/todolist.js");
...
calendarDates.addEventListener('click', (event) => {
    ...
    if(clickDateValue === '' || clickDateValue === undefined) {
        ...
        (0,_todo_todolist_js__WEBPACK_IMPORTED_MODULE_1__.displayClickDateTodoAdd)(false);
        displayClickDateTodoList(true, clickDateValue);
        (0,_todo_todolist_js__WEBPACK_IMPORTED_MODULE_1__.setTodoItemList)(_index_js__WEBPACK_IMPORTED_MODULE_0__.todoItemArr);
    });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "todoItemArr": () => (/* binding */ todoItemArr),
/* harmony export */   "TodoItem": () => (/* binding */ TodoItem),
/* harmony export */   "saveLocalTodoItem": () => (/* binding */ saveLocalTodoItem)
/* harmony export */ });
/* harmony import */ var _js_calendar_calendar_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../js/calendar/calendar.js */ "./src/js/calendar/calendar.js");
/* harmony import */ var _js_todo_todolist_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../js/todo/todolist.js */ "./src/js/todo/todolist.js");
/* harmony import */ var _js_main_main_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../js/main/main.js */ "./src/js/main/main.js");
...
function loadTodoItemLocalStroage() {
    ...
    (0,_js_calendar_calendar_js__WEBPACK_IMPORTED_MODULE_0__.default)(getTodoItemJSON);
    (0,_js_todo_todolist_js__WEBPACK_IMPORTED_MODULE_1__.setTodoItemList)(getTodoItemJSON, true);
}
...
(0,_js_main_main_js__WEBPACK_IMPORTED_MODULE_2__.initMain)();
...
/* harmony export */ });
/* harmony import */ var _weather_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./weather.js */ "./src/js/main/weather.js");
/* main.js 첫화면 */
...
function initMain() {
    ...
    loadName();
    (0,_weather_js__WEBPACK_IMPORTED_MODULE_0__.default)();
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "displayTodoAddAndBackButton": () => (/* binding */ displayTodoAddAndBackButton),
/* harmony export */   "setDisplayClickDateTodoModify": () => (/* binding */ setDisplayClickDateTodoModify)
/* harmony export */ });
/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../index.js */ "./src/js/index.js");
/* harmony import */ var _todolist_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./todolist.js */ "./src/js/todo/todolist.js");
/* harmony import */ var _calendar_calendar_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../calendar/calendar.js */ "./src/js/calendar/calendar.js");
...
todoAddButton.addEventListener('click', () => {
    ...
    const todoItem = new _index_js__WEBPACK_IMPORTED_MODULE_0__.TodoItem(form.date.value, form.title.value, form.time.value, form.notes.value);
    ...
    if (form.title.value === '') {
        ...
        (0,_index_js__WEBPACK_IMPORTED_MODULE_0__.saveLocalTodoItem)(todoItem);
        displayTodoAddAndBackButton(false);
        (0,_todolist_js__WEBPACK_IMPORTED_MODULE_1__.setTodoItemList)(_index_js__WEBPACK_IMPORTED_MODULE_0__.todoItemArr);
        (0,_calendar_calendar_js__WEBPACK_IMPORTED_MODULE_2__.default)(_index_js__WEBPACK_IMPORTED_MODULE_0__.todoItemArr, date);
    
        localStorage.setItem('todoItem', JSON.stringify(_index_js__WEBPACK_IMPORTED_MODULE_0__.todoItemArr));
...
function displayTodoAddAndBackButton(isAdd) {
    (0,_todolist_js__WEBPACK_IMPORTED_MODULE_1__.displayClickDateTodoAdd)(isAdd);
    const form = document.forms.todo;
...
function setDisplayClickDateTodoModify(todoArrIndex) {
    const todoItem = _index_js__WEBPACK_IMPORTED_MODULE_0__.todoItemArr[todoArrIndex];
    const form = document.forms.todo;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ setTodoItemList),
/* harmony export */   "setTodoItemList": () => (/* binding */ setTodoItemList),
/* harmony export */   "saveLocalTodoItem": () => (/* reexport safe */ _index_js__WEBPACK_IMPORTED_MODULE_0__.saveLocalTodoItem),
/* harmony export */   "displayClickDateTodoAdd": () => (/* binding */ displayClickDateTodoAdd)
/* harmony export */ });
/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../index.js */ "./src/js/index.js");
/* harmony import */ var _addlist_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./addlist.js */ "./src/js/todo/addlist.js");
/* harmony import */ var _calendar_calendar_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../calendar/calendar.js */ "./src/js/calendar/calendar.js");
...
todoListUl.addEventListener('click', ()=> {
    (0,_addlist_js__WEBPACK_IMPORTED_MODULE_1__.displayTodoAddAndBackButton)(true);
});
...
function modifyClickListener() {
    ...
    modifyTodoListMenu.forEach((modifyBt) => {
        modifyBt.addEventListener('click', () => {
            ...
            (0,_addlist_js__WEBPACK_IMPORTED_MODULE_1__.displayTodoAddAndBackButton)(true);
            (0,_addlist_js__WEBPACK_IMPORTED_MODULE_1__.setDisplayClickDateTodoModify)(idx);
        });
    });
    }
...
const deleteTodoListMenu = document.querySelectorAll('.drop-delete');
    deleteTodoListMenu.forEach((deleteBt) => {
        deleteBt.addEventListener('click', () => {
            ...
            const idx = todoArrfindIndex(todoArrIndex);
            const date = _index_js__WEBPACK_IMPORTED_MODULE_0__.todoItemArr[idx].clickDate.split(/[^0-9]/g)[2];
            console.log(date);

            _index_js__WEBPACK_IMPORTED_MODULE_0__.todoItemArr.splice(idx, 1);
            setTodoItemList(_index_js__WEBPACK_IMPORTED_MODULE_0__.todoItemArr);
            (0,_calendar_calendar_js__WEBPACK_IMPORTED_MODULE_2__.default)(_index_js__WEBPACK_IMPORTED_MODULE_0__.todoItemArr, date);
            localStorage.setItem('todoItem', JSON.stringify(_index_js__WEBPACK_IMPORTED_MODULE_0__.todoItemArr));
        }); 
    });
...
function todoArrfindIndex(todoArrIndex) {
    const idx = _index_js__WEBPACK_IMPORTED_MODULE_0__.todoItemArr.findIndex(function(item, index) { 
